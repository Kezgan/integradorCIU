...
xhttp.open("GET", "js/datosUsuarios.json", true);
xhttp.send();
xhttp.onreadystatechange = function() {
    if(this.readyState == 4 && this.status == 200) {
        ...
        for(let i of datos) {
            res.innerHTML += `
                <tr>
                    <td><img src=${"https://gravatar.com/avatar/" + MD5(i.nombre) + "?s=30&d=retro&r=x"}></td>
                    <td>${i.nombre}</td>
                    <td>${i.activo}</td>
...
function addDiv() {
   ...
   var formContraseña = document.getElementById("formContraseña")
   ...
   user.userNombre = formNombre.value
   user.userContraseña = formContraseña.value
   user.userEmail = formEmail.value
   user.userFecha = formFecha.value

   res.innerHTML += `
        <tr>
            <td><img src=${"https://gravatar.com/avatar/" + MD5(user.userNombre) + "?s=30&d=retro&r=x"}></td>
            <td>${formNombre.value}</td>
            <td>Si</td>
            <td><input type="checkbox" id="checkbox" name="input"></input></td>
        </tr>
    `

    arrayDatos[contador] = user
...
function eliminarFila() {
    ...
    if(contadorRow == 0) {
        ...
        setTimeout(function(){ alert("Eliminaste " + contadorRow + " elementos") } , 100)
    }
}
...
function editarFila() {
    ...
    for(var i=0; i<rowCount; i++) {
        ...
        if(chkbox.checked == true) {
            ...
            inputContraseña.value = arrayDatos[i].userContraseña
            inputEmail.value = arrayDatos[i].userEmail
            inputFecha.value = arrayDatos[i].userFecha
...
function guardar() {
    ...
    for(var i=0; i<rowCount; i++) {
        ...
        if(chkbox.checked == true) {
            row.cells[1].innerHTML = inputNombre.value
            row.cells[2].innerHTML = inputEstado.value
            arrayDatos[i].userNombre = inputNombre.value
            arrayDatos[i].userContraseña = inputContraseña.value
            arrayDatos[i].userEmail = inputEmail.value
            arrayDatos[i].userFecha = inputFecha.value
            arrayDatos[i].userEstado = inputEstado.value
